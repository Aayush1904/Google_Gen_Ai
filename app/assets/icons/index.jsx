...
export const Writing = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M437.3 67.9L292.7 212.5l90.9 90.9L528.2 160c12.5-12.5 12.5-32.8 0-45.3L482.6 67.9c-12.4-12.5-32.8-12.5-45.3 0zM52.3 403.5c-4.5 4.5-7.2 10.6-7.7 17L32 480c-.3 4.4 1.3 8.8 4.4 12s7.6 4.7 12 4.4l59.5-12.6c6.4-.5 12.5-3.2 17-7.7l268-268-90.9-90.9-268 268z"></path>
  </svg>
);
