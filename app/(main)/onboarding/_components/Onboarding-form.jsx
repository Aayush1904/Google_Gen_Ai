...
import { onboardingSchema } from "@/configs/schema"
...
const OnboardingForm = ({industries}) => {
    ...
    const {loading : updateLoading, fn : updateUserFn , data : updatedResult} = useFetch(updateUser)
    ...
    <div className="flex items-center justify-center bg-background">
      <Card className= "w-full max-w-lg mt-10 mx-2">
        <CardHeader>
            ...
            <CardDescription>Select your industry to get personalised learning pathways and recommandatins</CardDescription>
        </CardHeader>
        <CardContent>
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className = "space-y-2">
                    ...
                    <Input id="skills" placeholder = "e.g., Javascript , Python , RAG , Machine Learning" {...register("skills")} />
                    <p className="text-sm text-muted-foreground">Separate multiple skills with comas</p>
                    {errors.skills && (
                ...
                <div className = "space-y-2">
                    ...
                    <Textarea className="h-32" id="bio" placeholder = "Tell us About your Professional Background..." {...register("bio")} />
                    <p className="text-sm text-muted-foreground">Separate multiple skills with comas</p>
                    {errors.bio && (
