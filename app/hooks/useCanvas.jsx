...
export default function useCanvas() {
  ...
  const handleMouseDown = (event) => {
    ...
    lockUI(true);
      ...
      if (selectedTool === "writing") {
      setWritingPosition({ x: clientX, y: clientY });
      setCurrentText("");
      setIsWriting(true);
      return;
    }
  ...
  useLayoutEffect(() => {
    ...
    if (isWriting && currentText !== "") {
      ...
      context.fillText(currentText, writingPosition.x, writingPosition.y);
    }
    ...
    context.restore();
  }, [elements, isWriting , currentText , writingPosition , selectedElement, scale, translate, dimension]);
